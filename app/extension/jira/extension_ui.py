...
def app_specific_action(webdriver, datasets):
    ...
    def measure():
        ...
        def sub_measure():
            ...
            addButton.click()
            page.wait_until_visible((By.ID, "clients-custom_dict_2_name"))
            entryInput = page.get_element((By.ID, "clients-custom_dict_2_name"))
            entryInput.clear()
        ...
        def sub_measure():
            ...
            page.wait_until_visible((By.ID, "tl-ctl-dict-picker-customfield_11102-field"))
            customInput = page.get_element((By.ID, "tl-ctl-dict-picker-customfield_11102-field"))
            customInput.clear()
